...
SECRET_KEY = env('DJANGO_SECRET_KEY', default='dev-key-change-in-production-not-for-use-outside-local')
...
# Default DB — overridden in local.py and production.py
DATABASES = {
...
CREDIT_COST_PER_MINUTE = 1  # 1 credit = 1 minute
